...
def load_data(split_idx=0, reserved_design_name="mgc_des_perf_2"):
    #idx 0-5
    #with open("tmp/filelist.pkl", "rb") as f:
    #    filenames = pickle.load(f)
    #    f.close()
    # reserved = ["mgc_des_perf_1"]
    # reserved = ["mgc_des_perf_2"]
    # reserved = ["mgc_fft_a"]
    # reserved = ["mgc_fft_b"]
    # reserved = ["mgc_fft_1"]
    # reserved = ["mgc_fft_2"]
    reserved = [f"{reserved_design_name}"]
    ...
    # fout = gzip.GzipFile("mgc_des_perf_1.pkl", "wb")
    # fout = gzip.GzipFile("mgc_des_perf_2.pkl", "wb")
    fout = gzip.GzipFile(f"{reserved_design_name}.pkl", "wb")

    pickle.dump((imagesTrain, labelsTrain, e_ccTrain, e_nnTrain, w_nnTrain, v_nTrain, e_cnTrain), fout)
    fout.close()

if __name__ == "__main__":
    for d_name in ['mgc_des_perf_1', 'mgc_des_perf_a', 'mgc_des_perf_b', 'mgc_edit_dist_a', 'mgc_fft_a_flex', 'mgc_fft_b_flex', 'mgc_matrix_mult_1', 'mgc_matrix_mult_2', 'mgc_matrix_mult_a', 'mgc_matrix_mult_b', 'mgc_matrix_mult_c', 'mgc_pci_bridge32_a__', 'mgc_pci_bridge32_b__', 'mgc_pci_bridge32_a_flex',  'mgc_pci_bridge32_b_flex', 'mgc_superblue11_a', 'mgc_superblue12', 'mgc_superblue14', 'mgc_superblue16_a', 'mgc_superblue19']:
        load_data(0, d_name)
