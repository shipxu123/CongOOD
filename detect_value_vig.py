...
def split_dataset(dataset_dir):
    ...
    _, indices = torch.sort(torch.Tensor(mean_values))
    ...
    return indices_part1, indices_part2


def detect_vig(dataset_dir):
    ...
    indices_part1, indices_part2 = split_dataset(dataset_dir)
    ...
    train_data, test_data = torch.utils.data.random_split(ind_data, [num_train, n_ind - num_train], gen1)

    train_loader = GraphDataLoader(train_data, batch_size=BATCH_SIZE, shuffle=True, num_workers=4)
    test_loader  = GraphDataLoader(test_data, batch_size=BATCH_SIZE, shuffle=False, num_workers=4)
    ood_loader   = GraphDataLoader(ood_data, batch_size=BATCH_SIZE, shuffle=False, num_workers=4)
...
if __name__ == '__main__':
    ...
    detect_vig("mgc_matrix_mult_1.pkl")